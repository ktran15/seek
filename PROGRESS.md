...
| 2 | Expo + TypeScript (strict) + Expo Router project init; boots | ⬜ not started |
| 3 | Supabase wiring: client module, env vars, .env.example (client-safe keys only) | ⬜ not started |
...
**Next step:** sub-step 2 — scaffold the Expo app.
