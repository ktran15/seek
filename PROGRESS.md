...
| 9 | Batch generation: eyes (3), hair (5×5), cosmetics (32), mascot states (cheer/defeat), badges (4), flags/trail/summit, logo/loading | ⬜ shakedown next (throttled API pipeline — see sub-step 10) |
